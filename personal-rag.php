...
Description: Private local RAG over WordPress posts and pages using Ollama embeddings, WordPress AI Connectors, and WordPress database-backed storage.
Version: 0.2.0
...
define( 'PERSONAL_RAG_VERSION', '0.2.0' );
...
require_once PERSONAL_RAG_DIR . 'includes/class-personal-rag-settings.php';
...
require_once PERSONAL_RAG_DIR . 'includes/class-personal-rag-ai.php';
